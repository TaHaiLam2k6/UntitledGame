...
#@onready var player_avatar:TextureRect=$UIContatner/PlayerAvatar
...
const avatar_map: Dictionary ={
	Character.Type.PUNK: preload("res://assets/avatar-punk.png"),
	Character.Type.BOUNCER: preload("res://assets/avatar-boss.png"),
}
func _init() -> void:
